...
-----------
**One can use online tool [Ginkgo] (http://qb.cshl.edu/ginkgo/) for intial profiling (need to upload all .bed files) or follow following steps for a large scale analysis on local computers:** 
