...
-----------
**One can use online tool [Ginkgo] (http://qb.cshl.edu/ginkgo/) for intial profiling (need to upload all .bed files) or follow following steps for large scale analysis on local PC:** 
