...
Sinsat provides functions for performancing CNA analysis with Single-cell DNA sequencing. Current pipeline majorly facilitates the binless segemenation (CNA break point detection) of single-cell sequencing data. These breakpoints may be used as surrogates for SNVs.
